...
const Addproblem = () => {
  ...
  return (
    <div>
      ...
      {/* <div className="container-fuid container-xss"> */}
      ...
      {/*           
        ...
        <div className='heading'>
            ...
            <input style={{color:"white"}}  type="text"onChange={description}className='shortdescription'placeholder="Typehere..."/>
            <div className='written'>{length?length:0}/200</div>
            </div>
            ...
            <div className='add-image-xxd'>
            <input type="file" required onChange={imagefile} className='problem' accept="image/*"/>
            <img src={ImgFrame}className="addimg"alt="bacground-col"/>
            {
              backgroundimage?<img src={image} className='img-334'/>:""
            }
